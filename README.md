...
| ![Tf](https://img.shields.io/badge/TERRAFORM-blueviolet) 1.3.7 | ![Gitlab](https://img.shields.io/badge/GITLAB-red) | ![Aws](https://img.shields.io/badge/AWS-orange) | [Gitlab Repo](https://gitlab.com/a_achter_cicd/gitops-with-argocd-eks-and-gitlab-ci-using-terraform.git) ![Terraform](https://gitlab.com/a_achter_cicd/gitops-with-argocd-eks-and-gitlab-ci-using-terraform//badges/main/pipeline.svg)| GitOps with ArgoCD, EKS and GitLab CI using Terraform |
